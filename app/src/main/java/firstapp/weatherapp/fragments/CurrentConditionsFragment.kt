package firstapp.weatherapp.fragments
...
import firstapp.weatherapp.databinding.FragmentCurrentConditionsBinding
import firstapp.weatherapp.viewmodels.CurrentConditionViewModel
...
class CurrentConditionsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        args.weatherResponse?.let {
            ...
            binding.tvTempratureBig.text = formatUptoTwoDecimal(it.main.temp.minus(273)*9/5 +32)+"\u2109"
            binding.tvFeelsLike.text="Feels like "+formatUptoTwoDecimal(it.main.feels_like?.minus(273)*9/5 +32 )+"\u2109"
            binding.tvHigh.text="High "+formatUptoTwoDecimal(it.main.temp_max.minus(273)*9/5 +32 )+"\u2109"
            binding.tvLow.text="Low "+formatUptoTwoDecimal(it.main.temp_min.minus(273) *9/5 +32)+"\u2109"
